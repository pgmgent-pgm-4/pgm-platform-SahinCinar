  ...
  */
  const createUsers = async (n = 20) => {
    ...
    for (let i=0; i < n;i++) {
      ...
      promises.push(await createUser({username: faker.internet.userName(firstName, lastName), email: faker.internet.email(firstName, lastName), password: 'pgmGent5858', firstname: firstName, lastname: lastName}));
    }
